...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i16.HomeProvider>(
        () => _i16.HomeProvider(gh<_i14.CoreApi>()));
    gh.lazySingleton<_i17.HomeRepository>(
        () => _i18.HomeRepositoryImpl(gh<_i16.HomeProvider>()));
    gh.lazySingleton<_i19.GameRepository>(
        () => _i20.GameRepositoryImpl(gh<_i15.GameProvider>()));
    gh.factory<_i21.HomeBloc>(() => _i21.HomeBloc(gh<_i17.HomeRepository>()));
    gh.factory<_i22.GameViewBloc>(
        () => _i22.GameViewBloc(gh<_i19.GameRepository>()));
    return this;
  }
}
